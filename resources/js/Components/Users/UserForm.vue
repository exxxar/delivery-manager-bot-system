<template>
    ...
    <form @submit.prevent="submitForm">
            ...
            <!-- Telegram Chat ID -->
            <div class="form-floating mb-2">
                <input v-model="form.telegram_chat_id" type="text" class="form-control" id="telegram_chat_id" placeholder="Telegram Chat ID">
            ...
            <!-- Процент -->
            <div class="form-floating mb-2">
                <input v-model="form.percent" type="number" step="0.01" class="form-control" id="percent" placeholder="Процент">
